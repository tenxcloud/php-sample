<div style="width: 800px;">
    <form id="step_edit_form">
        <ul class="nav nav-skid" id="flow_edit_tab">
            <li<?php if ( $op == 'base' ): ?> class="active"<?php endif; ?>><a href="#step_basic_info" data-toggle="tab"><?php echo $lang['Base info']; ?></a></li>
            <li<?php if ( $op == 'field' ): ?> class="active"<?php endif; ?>><a href="#step_form_field" data-toggle="tab"><?php echo $lang['Form fields']; ?></a></li>
            <li<?php if ( $op == 'handle' ): ?> class="active"<?php endif; ?>><a href="#step_operator" data-toggle="tab"><?php echo $lang['Handle role']; ?></a></li>
            <li<?php if ( $op == 'condition' ): ?> class="active"<?php endif; ?>><a href="#step_condition" data-toggle="tab"><?php echo $lang['Condition setup']; ?></a></li>
            <li<?php if ( $op == 'setting' ): ?> class="active"<?php endif; ?>><a href="#step_settings" data-toggle="tab"><?php echo $lang['Other setup']; ?></a></li>
        </ul>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="type" id="node_type" class="span6">
                                <option value="0" <?php if ( $prcs['type'] == '0' ): ?>selected<?php endif; ?>><?php echo $lang['Step node']; ?></option>
                                <option value="1" <?php if ( $prcs['type'] == '1' ): ?>selected<?php endif; ?>><?php echo $lang['Child flow node']; ?></option>
                            </select>
                        </div>
                    </div>
                            ...
                            <div class="controls">
                                <select name="childflow" class="span6" id="subflow_type">
                                    <?php foreach ( $flows as $flow ): ?>
                                        <option value="<?php echo $flow['flowid']; ?>" <?php if ( $prcs['childflow'] == $flow['flowid'] ): ?>selected<?php endif; ?>><?php echo $flow['name']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="radio radio-inline">
                                    <input type="radio" name="over_act" data-act="overAct" value="0" <?php if ( $prcs['overact'] == 0 ): ?>checked<?php endif; ?> />
                                    <?php echo $lang['End action 1']; ?>
                                </label>
                                <label class="radio radio-inline">
                                    <input type="radio" name="over_act" data-act="overAct" value="1" <?php if ( $prcs['overact'] == 1 ): ?>checked<?php endif; ?> />
                                    <?php echo $lang['End action 2']; ?>
                                </label>
                            </div>
                        </div>
                        <div id="subflow_prcs_back"<?php if ( $prcs['overact'] == 0 ): ?> style="display: none;<?php endif; ?>">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="prcsback" id="subflow_return_step" class="span6">
                                        ...
                                        <?php foreach ( $backprcs as $back ): ?>
                                            <option value="<?php echo $back['processid']; ?>" <?php if ( $prcs['processto'] == $back['processid'] ): ?>selected<?php endif; ?>><?php echo sprintf( '%d、%s', $back['processid'], $back['name'] ); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
            ...
            <div class="tab-pane <?php if ( $op == 'handle' ): ?>active<?php else: ?>fade<?php endif; ?>" id="step_operator">
                <fieldset class="form-horizontal form-narrow fill">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="userfilter" id="operator_filters" class="span6">
                                <option value="" <?php if ( empty( $prcs['userfilter'] ) ): ?>selected<?php endif; ?>><?php echo $lang['Filtering rules 1']; ?></option>
                                <option value="1" <?php if ( $prcs['userfilter'] == '1' ): ?>selected<?php endif; ?>><?php echo $lang['Filtering rules 2']; ?></option>
                                <option value="3" <?php if ( $prcs['userfilter'] == '3' ): ?>selected<?php endif; ?>><?php echo $lang['Filtering rules 3']; ?></option>
                                <option value="4" <?php if ( $prcs['userfilter'] == '4' ): ?>selected<?php endif; ?>><?php echo $lang['Filtering rules 4']; ?></option>
                                <option value="2" <?php if ( $prcs['userfilter'] == '2' ): ?>selected<?php endif; ?>><?php echo $lang['Filtering rules 5']; ?></option>
                            </select>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="autotype" id="operator_automatic" class="span6">
                                <option value="" <?php if ( empty( $prcs['autotype'] ) ): ?>selected<?php endif; ?>><?php echo $lang['Automatic rules 1']; ?></option>
                                <option value="1" <?php if ( $prcs['autotype'] == '1' ): ?>selected<?php endif; ?>><?php echo $lang['Automatic rules 2']; ?></option>
                                <option value="2" <?php if ( $prcs['autotype'] == '2' ): ?>selected<?php endif; ?>><?php echo $lang['Automatic rules 3']; ?></option>
                                <option value="4" <?php if ( $prcs['autotype'] == '4' ): ?>selected<?php endif; ?>><?php echo $lang['Automatic rules 4']; ?></option>
                                <option value="6" <?php if ( $prcs['autotype'] == '6' ): ?>selected<?php endif; ?>><?php echo $lang['Automatic rules 5']; ?></option>
                                <option value="5" <?php if ( $prcs['autotype'] == '5' ): ?>selected<?php endif; ?>><?php echo $lang['Automatic rules 6']; ?></option>
                                <option value="3" <?php if ( $prcs['autotype'] == '3' ): ?>selected<?php endif; ?>><?php echo $lang['Automatic rules 7']; ?></option>
                                <option value="7" <?php if ( $prcs['autotype'] == '7' ): ?>selected<?php endif; ?>><?php echo $lang['Automatic rules 8']; ?></option>
                                <option value="8" <?php if ( $prcs['autotype'] == '8' ): ?>selected<?php endif; ?>><?php echo $lang['Automatic rules 9']; ?></option>
                                <option value="9" <?php if ( $prcs['autotype'] == '9' ): ?>selected<?php endif; ?>><?php echo $lang['Automatic rules 10']; ?></option>
                                <option value="10" <?php if ( $prcs['autotype'] == '10' ): ?>selected<?php endif; ?>><?php echo $lang['Automatic rules 11']; ?></option>
                            </select>
                    ...
                    <div>
                            ...
                            <div class="controls">
                                <select name="autobaseuser" id="operator_for_select" class="span6">
                                    ...
                                    <?php foreach ( $autoprcs as $id => $name ): ?>
                                        <option value="<?php echo $id; ?>" <?php if ( $prcs['autobaseuser'] == $id ): ?>selected<?php endif; ?>><?php echo sprintf( '%d、%s', $id, $name ); ?></option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="control-group" id="assign_step" style="display: none;">
                            ...
                            <div class="controls">
                                <select name="autoprcsuser" id="assign_step_select" class="span6">
                                    <?php foreach ( $autoprcs as $id => $name ): ?>
                                        <option value="<?php echo $id; ?>" <?php if ( $prcs['autotype'] == '8' && $prcs['autouser'] == $id ): ?>selected<?php endif; ?>><?php echo sprintf( '%d、%s', $id, $name ); ?></option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <!-- 指定自动选择默认人员 -->
                        <div id="assign_user" <?php if ( $prcs['autotype'] !== '3' ): ?>style="display: none;"<?php endif; ?>>
                            ...
                            <tbody style="border-top: 1px solid #D8D8D8;">
                                <tr>
                                    <td style='text-align: center;padding-left: 0;'>
                                        <span class="label"><?php echo $id; ?></span><br/><br/><?php echo $condition['name']; ?>
                                    </td>
                                    <td>
            ...
            <div class="tab-pane fade" id="step_settings" >
                <fieldset  class="form-horizontal form-narrow fill">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="topdefault" class="span6">
                                <option value="0" <?php if ( $prcs['topdefault'] == '0' ): ?>selected<?php endif; ?>><?php echo $lang['Host option 1']; ?></option>
                                <option value="2" <?php if ( $prcs['topdefault'] == '2' ): ?>selected<?php endif; ?>><?php echo $lang['Host option 2']; ?></option>
                                <option value="1" <?php if ( $prcs['topdefault'] == '1' ): ?>selected<?php endif; ?>><?php echo $lang['Host option 3']; ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label></label>
                            <input type="checkbox" name="userlock" id="allowed_change" value="1" <?php if ( $prcs['userlock'] == '1' ): ?>checked<?php endif; ?>>
                        </div>
                    </div>		
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="feedback" class="span4" id="sign_options">
                                <option value="0" <?php if ( $prcs['feedback'] == '0' ): ?>selected<?php endif; ?>><?php echo $lang['Sign option 1']; ?></option>
                                <option value="1" <?php if ( $prcs['feedback'] == '1' ): ?>selected<?php endif; ?>><?php echo $lang['Sign option 2']; ?></option>
                                <option value="2" <?php if ( $prcs['feedback'] == '2' ): ?>selected<?php endif; ?>><?php echo $lang['Sign option 3']; ?></option>
                            </select>
                    ...
                    <div class="control-group" id="sign_visibility">
                        ...
                        <div class="controls">
                            <select name="signlook" class="span6">
                                <option value="0" <?php if ( $prcs['signlook'] == '0' ): ?>selected<?php endif; ?>><?php echo $lang['Sign opinion 1'] ?></option>
                                <option value="1" <?php if ( $prcs['signlook'] == '1' ): ?>selected<?php endif; ?>><?php echo $lang['Sign opinion 2'] ?></option>
                                <option value="2" <?php if ( $prcs['signlook'] == '2' ): ?>selected<?php endif; ?>><?php echo $lang['Sign opinion 3'] ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="checkbox" name="turnpriv" value="1" <?php if ( $prcs['turnpriv'] == '1' ): ?>checked<?php endif; ?> id="force_forward" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio radio-inline">
                                <input type="radio" value="0" name="allowback" <?php if ( $prcs['allowback'] == '0' ): ?>checked<?php endif; ?> />
                                <?php echo $lang['Not allow']; ?>
                            </label>
                            <label class="radio radio-inline">
                                <input type="radio" value="1" name="allowback" <?php if ( $prcs['allowback'] == '1' ): ?>checked<?php endif; ?> />
                                <?php echo $lang['Return to prev step']; ?>
                            </label>
                            <label class="radio radio-inline">
                                <input type="radio" value="2" name="allowback" <?php if ( $prcs['allowback'] == '2' ): ?>checked<?php endif; ?> />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio radio-inline">
                                <input type="radio" value="0" name="syncdeal" <?php if ( $prcs['syncdeal'] == '0' ): ?>checked<?php endif; ?> />
                                <?php echo $lang['Concurrent option 1']; ?>
                            </label>
                            <label class="radio radio-inline">
                                <input type="radio" value="1" name="syncdeal" <?php if ( $prcs['syncdeal'] == '1' ): ?>checked<?php endif; ?> />
                                <?php echo $lang['Concurrent option 2']; ?>
                            </label>
                            <label class="radio radio-inline">
                                <input type="radio" value="2" name="syncdeal" <?php if ( $prcs['syncdeal'] == '2' ): ?>checked<?php endif; ?> />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio radio-inline">
                                <input type="radio" name="gathernode" value="0" <?php if ( $prcs['gathernode'] == '0' ): ?>checked<?php endif; ?> />
                                <?php echo $lang['Concurrent merger 1']; ?>
                            </label>
                            <label class="radio radio-inline">
                                <input type="radio" name="gathernode" value="1" <?php if ( $prcs['gathernode'] == '1' ): ?>checked<?php endif; ?> />
                        ...
                        <div class="controls">
                            <div>
                                <label class="checkbox checkbox-inline">
                                    <input type="checkbox" value="1" name="attachpriv[]" <?php if ( in_array( '1', $prcs['attachpriv'] ) ): ?>checked<?php endif; ?> />
                                    <?php echo $lang['New permissions']; ?>
                                </label>
                                <label class="checkbox checkbox-inline">
                                    <input type="checkbox" value="2" name="attachpriv[]" <?php if ( in_array( '2', $prcs['attachpriv'] ) ): ?>checked<?php endif; ?> />
                                    <?php echo $lang['Edit permissions']; ?>
                                </label>
                                <label class="checkbox checkbox-inline">
                                    <input type="checkbox" value="3" name="attachpriv[]" <?php if ( in_array( '3', $prcs['attachpriv'] ) ): ?>checked<?php endif; ?> />
                                    <?php echo $lang['Delete permissions']; ?>
                                </label>
                                <label class="checkbox checkbox-inline">
                                    <input type="checkbox" value="4" name="attachpriv[]" <?php if ( in_array( '4', $prcs['attachpriv'] ) ): ?>checked<?php endif; ?> />
                                    <?php echo $lang['Download permissions']; ?>
                                </label>
                                <label class="checkbox checkbox-inline">
                                    <input type="checkbox" value="5" name="attachpriv[]" <?php if ( in_array( '5', $prcs['attachpriv'] ) ): ?>checked<?php endif; ?> />
...
<script>
    ...
    $(function() {
        ...
        var showPluginsDialog = function() {
            Ui.dialog({
                id: "d_plugin_dialog",
                title: Ibos.l("WF.PLUGIN_SELECT"),
                content: Ibos.l("WF.NO_PLUGIN_AVAILABLE"),
                cancel: true,
        ...
        var fieldMatchUp = {
            ...
            add: function(parent, child) {
                ...
                if (this.$container.find("li[data-value='" + id + "']").length) {
                    Ui.tip(Ibos.l("WF.EXISTING_CORRESPONDENCE"), "warning");
                    return;
                }
