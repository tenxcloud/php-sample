		...
		<div class="main">
												...
												<li class="cmt-item">
													<div class="cmt-body fss">
														<p class="xcm">
															...
															<?php echo $rp['content']; ?>
															<small>(<?php echo Convert::formatDate( $rp['edittime'], 'u' ); ?>)</small>
														</p>
													</div>
												</li>
												<?php endforeach; ?>
			...
			<?php if ( !empty( $viewflow ) ): ?>
				<div class="main-content">
					<div class="form-content">
						<table width="100%">
							<caption><?php $lang['Steps and flow chart']; ?></caption>
							<tbody>
							<?php foreach ( $viewflow as $key => $val ): ?>
								<tr>
									<td>
										...
										<div>
											<?php if ( !isset( $val['name'] ) ): ?><?php echo Ibos::lang( 'Step', '', array( '{step}' => $key ) ) ?><?php else: ?>[<?php echo $val['name']; ?>]<?php endif; ?> 
