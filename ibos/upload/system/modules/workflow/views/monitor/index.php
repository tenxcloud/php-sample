...
<div class="mc clearfix">
	...
	<div class="mcr">
		...
		<div class="page-list clearfix">
								...
								<tr id="list_tr_<?php echo $val['runid']; ?>">
									...
									<td class="posr">
										...
										<div class="right-btnbar">
											...
											<?php if ( $val['freeother'] != 0 ): ?><button type="button" data-click="entrust" data-param="{&quot;key&quot;: &quot;<?php echo $val['key']; ?>&quot;,&quot;manager&quot;:1}" class="btn btn-mini"><?php echo $lang['Entrust']; ?></button><?php endif; ?>
			...
			<!--右栏列表 结束-->
			<!--右栏底部功能栏 开始-->
			<?php if ( $pages->getItemCount() > $pages->getPageSize() ): ?>
						...
						<div class="btn-group dropup">
							...
							<ul class="dropdown-menu" id="page_num_menu">
								<li <?php if ( $pageSize == 10 ): ?>class="active"<?php endif; ?>>
									<a href="<?php echo $this->createUrl( 'monitor/index', array( 'pagesize' => 10 ) ); ?>"><?php echo $lang['Each page']; ?> 10</a>
								</li>
								<li <?php if ( $pageSize == 20 ): ?>class="active"<?php endif; ?>>
									<a href="<?php echo $this->createUrl( 'monitor/index', array( 'pagesize' => 20 ) ); ?>"><?php echo $lang['Each page']; ?> 20</a>
								</li>
								<li <?php if ( $pageSize == 30 ): ?>class="active"<?php endif; ?>>
									<a href="<?php echo $this->createUrl( 'monitor/index', array( 'pagesize' => 30 ) ); ?>"><?php echo $lang['Each page']; ?> 30</a>
								</li>
								<li <?php if ( $pageSize == 40 ): ?>class="active"<?php endif; ?>>
									<a href="<?php echo $this->createUrl( 'monitor/index', array( 'pagesize' => 40 ) ); ?>"><?php echo $lang['Each page']; ?> 40</a>
								</li>
								<li <?php if ( $pageSize == 50 ): ?>class="active"<?php endif; ?>>
									<a href="<?php echo $this->createUrl( 'monitor/index', array( 'pagesize' => 50 ) ); ?>"><?php echo $lang['Each page']; ?> 50</a>
								</li>
							</ul>
						</div>
					</div>
