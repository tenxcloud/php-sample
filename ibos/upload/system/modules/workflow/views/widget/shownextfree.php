		...
		<div id="wfSetnext">
			<?php if ( $preset != '' ): ?>
				<div class="options-choose">
					<div class="mb step-title"><?php echo $lang['The'] . $nextId . $lang['Step']; ?>:(<?php echo $lang['Next step']; ?>)<span style="color:red;"><?php echo $lang['The steps for the preset']; ?></span></div>
			...
			<?php else: ?>
				<div class="options-choose">
					<div class="mb step-title"><?php echo $lang['The'] . $nextId . $lang['Step']; ?>:(<?php echo $lang['Next step']; ?>)</div>
					<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						<span style="margin-right: 20px;">
							<a onclick="snf.add_prcs(<?php echo $nextId + 1; ?>);" href="javascript:;" class="xi2">
								<i class="o-plus"></i>
