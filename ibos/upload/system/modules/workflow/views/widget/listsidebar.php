	...
	<div class="sbbf sbbf sbbl">
		...
		<div class="sbb sbbf">
			<ul class="nav nav-stacked nav-strip">
				<li <?php if ( $control == 'list' ): ?>class="active"<?php endif; ?>>
				...
				<li <?php if ( $control == 'focus' ): ?>class="active"<?php endif; ?>>
		...
		<div>
			<ul class="nav nav-stacked nav-strip">
	            <li<?php if ( $control == 'type' ): ?> class="active"<?php endif; ?>>
					...
					<?php if ( $control == 'type' ): ?>
						<ul class="sbb-list">
							<?php foreach ( $category as $cat ): ?>
								<li <?php if ( $catId == $cat['catid'] ): ?>class="active"<?php endif; ?>><a href="<?php echo Ibos::app()->createUrl( 'workflow/type/index', array( 'catid' => $cat['catid'] ) ); ?>"><?php echo $cat['name']; ?></a></li>
							<?php endforeach; ?>
						</ul>
					<?php endif; ?>
				</li>
				<li<?php if ( $control == 'formtype' ): ?> class="active"<?php endif; ?>>
					...
					<?php if ( $control == 'formtype' ): ?>
						<ul class="sbb-list">
							<?php foreach ( $category as $cat ): ?>
								<li <?php if ( $catId == $cat['catid'] ): ?>class="active"<?php endif; ?>><a href="<?php echo Ibos::app()->createUrl( 'workflow/formtype/index', array( 'catid' => $cat['catid'] ) ); ?>"><?php echo $cat['name']; ?></a></li>
							<?php endforeach; ?>
						</ul>
					<?php endif; ?>
				</li>
