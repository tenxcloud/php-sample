					...
					<tr id="list_tr_<?php echo $run['runid']; ?>">
						...
						<td class="posr">
							...
							<div class="right-btnbar">
								...
								<?php if ( isset( $run['del'] ) ): ?><a href="javascript:void(0);" data-click="del" data-param="<?php echo $run['runid']; ?>" class="btn btn-small pull-right btn-host"><?php echo $lang['Delete']; ?></a><?php endif; ?>
							</div>
						</td>
					</tr>
				<?php endforeach; ?>
