					...
					<tr id="list_tr_<?php echo $run['runid']; ?>">
						...
						<td>
							<div class="com-list-name">
								<em class="text-nowrap"><a class="xcm" title="<?php echo $run['runName']; ?>" target="_blank" href="<?php echo Ibos::app()->createUrl( 'workflow/preview/print', array( 'key' => $run['key'] ) ); ?>"><?php echo String::cutStr( $run['runName'], 50 ); ?></a></em>
							...
							<div>
								<div class="btn-toolbar right-btnbar pull-right">
									<?php if ( isset( $run['rollback'] ) ): ?>
										<a href="javascript:void(0);" data-action="takeback" data-param="{&quot;key&quot;: &quot;<?php echo $run['key']; ?>&quot;}" class="btn btn-small pull-left btn-host"><?php echo $lang['Take back']; ?></a>
									<?php endif; ?>
									<div class="btn-group">
