					...
					<tr id="list_tr_<?php echo $run['runid']; ?>">
						...
						<td>
							<div class="com-list-name">
								<em class="text-nowrap"><a class="<?php if ( $run['flag'] == '1' ): ?>xwb xcbu<?php else: ?>xcm<?php endif; ?>" title="<?php echo $run['runName']; ?>" target="_blank" href="<?php echo Ibos::app()->createUrl( 'workflow/preview/print', array( 'key' => $run['key'] ) ); ?>"><?php echo String::cutStr( $run['runName'], 25 ); ?></a></em>
						...
						<td class="posr">
							<span class="art-list-time"><?php echo Convert::formatDate( $run['begintime'] ); ?></span>
							<div class="right-btnbar">
									...
									<div class="btn-group">
										...
										<ul class="dropdown-menu" role="menu">
											...
											<?php if ( isset( $run['delay'] ) ): ?>
												<li><a href="javascript:;" class="todo-delay" data-action="delay" data-param="{&quot;key&quot;: &quot;<?php echo $run['key']; ?>&quot;}"><?php echo $lang['Delay']; ?></a></li>
											<?php endif; ?>
								...
								<?php if ( isset( $run['host'] ) || isset( $run['sign'] ) ): ?>
									<a href="<?php echo Ibos::app()->createUrl( 'workflow/form/index', array( 'key' => $run['key'] ) ); ?>" class="btn btn-primary btn-small pull-right btn-host">
										<?php if ( isset( $run['host'] ) ): ?><?php echo $lang['Host']; ?><?php else: ?><?php echo $lang['Sign']; ?><?php endif; ?>
									</a>
								<?php endif; ?>
							</div>
						</td>
