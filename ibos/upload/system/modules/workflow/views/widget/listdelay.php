		...
		<table class="table table-hover table-striped table-to-do" id="article_table">
			<thead>
				<tr>
					...
					<th width="140"><?php echo $lang['Steps and flow chart']; ?></th>
					<th width="140"></th>
					<th width="20"></th>
				</tr>
			</thead>
					...
					<tr id="list_tr_<?php echo $run['runid']; ?>">
						...
						<td>
							<div class="com-list-name">
								<em class="text-nowrap"><a class="xcm" title="<?php echo $run['runName']; ?>" href="<?php echo Ibos::app()->createUrl( 'workflow/preview/print', array( 'key' => $run['key'] ) ); ?>" target="_blank"><?php echo String::cutStr( $run['runName'], 50 ); ?></a></em>
						...
						<td>
							<div class="right-btnbar">
								...
								<?php if ( isset( $run['restore'] ) ): ?>
									<a href="javascript:void(0);" data-action="restore" data-param="{&quot;key&quot;: &quot;<?php echo $run['key']; ?>&quot;}" class="btn btn-small pull-right btn-host"><?php echo $lang['Restore']; ?></a>
								<?php endif; ?>
							</div>
						</td>
						<td>
