				...
				<fieldset>
							...
							<select name="catid" id="flow_catid" class="span3">
								<?php if ( !empty( $this->category ) ): ?>
									<?php foreach ( $this->category as $category ): ?>
										<option<?php if ( $category['catid'] == $flow['catid'] ): ?> selected<?php endif; ?> value="<?php echo $category['catid']; ?>"><?php echo $category['name']; ?></option>
									<?php endforeach; ?>
								<?php endif; ?>
							</select>
						</div>
					...
					<div class="control-group">
						...
						<div class="controls" id="flow_type">
							<label class="radio radio-inline"><input type="radio" name="type" value="1" <?php if ( $flow['type'] == '1' ): ?>checked<?php endif; ?> <?php if ( $readonly ): ?>disabled<?php endif; ?> /><?php echo $lang['Fixed flow']; ?></label>
							<label class="radio radio-inline"><input type="radio" name="type" value="2" <?php if ( $flow['type'] == '2' ): ?>checked<?php endif; ?> <?php if ( $readonly ): ?>disabled<?php endif; ?> /><?php echo $lang['Free flow']; ?></label>
						</div>
					</div>
					<div class="control-group" id="free_set">
						<label class="control-label"><?php echo $lang['Allow default step']; ?></label>
						<div class="controls">
							<label class="radio radio-inline"><input type="radio" name="freepreset" value="1" <?php if ( $flow['freepreset'] == '1' ): ?>checked<?php endif; ?> /><?php echo $lang['Yes']; ?></label>
							<label class="radio radio-inline"><input type="radio" name="freepreset" value="0" <?php if ( $flow['freepreset'] == '0' ): ?>checked<?php endif; ?> /><?php echo $lang['No']; ?></label>
						</div>
					</div>
					<div class="control-group">
							...
							<div class="row">
								<div class="span5">
									<select name="freeother" id="">
										<option value="2" <?php if ( $flow['freeother'] == '2' ): ?>selected<?php endif; ?>><?php echo $lang['Free to entrust']; ?></option>
										<option value="3" <?php if ( $flow['freeother'] == '3' ): ?>selected<?php endif; ?>><?php echo $lang['Entrust by step']; ?></option>
										<option value="1" <?php if ( $flow['freeother'] == '1' ): ?>selected<?php endif; ?>><?php echo $lang['Entrust by current step agent']; ?></option>
										<option value="0" <?php if ( $flow['freeother'] == '0' ): ?>selected<?php endif; ?>><?php echo $lang['Prohibit to entrust']; ?></option>
									</select>
								</div>
							</div>
						</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<label class="checkbox checkbox-inline"><input type="checkbox" name="allowattachment" value="1" <?php if ( $flow['allowattachment'] == '1' ): ?>checked<?php endif; ?> /><?php echo $lang['Allow attachment']; ?></label>
							<!--<label class="checkbox checkbox-inline"><input type="checkbox" name="allowversion" value="1" <?php //if ( $flow['allowversion'] == '1' ): ?>checked<?php //endif; ?> /><?php //echo $lang['Enable version control']; ?></label>-->
						</div>
					</div>
					<div class="control-group">
						<label class="control-label"><?php echo $lang['Using state']; ?>&nbsp;<i id="using_state" class="glyphicon-info-sign"></i></label>
						<div class="controls">
							<label class="radio radio-inline"><input type="radio" value="1" name="usestatus" <?php if ( $flow['usestatus'] == '1' ): ?>checked<?php endif; ?>><?php echo $lang['Visible']; ?></label>
							<label class="radio radio-inline"><input type="radio" value="2" name="usestatus" <?php if ( $flow['usestatus'] == '2' ): ?>checked<?php endif; ?>><?php echo $lang['Invisible']; ?></label>
							<label class="radio radio-inline"><input type="radio" value="3" name="usestatus" <?php if ( $flow['usestatus'] == '3' ): ?>checked<?php endif; ?>><?php echo $lang['Lock']; ?></label>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<select name="autoedit" id="auto_edit" class="span6">
									<option value="1" <?php if ( $flow['autoedit'] == '1' ): ?>selected<?php endif; ?>><?php echo $lang['Auto edit option 1']; ?></option>
									<option value="0" <?php if ( $flow['autoedit'] == '0' ): ?>selected<?php endif; ?>><?php echo $lang['Auto edit option 0']; ?></option>
									<option value="2" <?php if ( $flow['autoedit'] == '2' ): ?>selected<?php endif; ?>><?php echo $lang['Auto edit option 2']; ?></option>
									<option value="3" <?php if ( $flow['autoedit'] == '3' ): ?>selected<?php endif; ?>><?php echo $lang['Auto edit option 3']; ?></option>
									<option value="4" <?php if ( $flow['autoedit'] == '4' ): ?>selected<?php endif; ?>><?php echo $lang['Auto edit option 4']; ?></option>
								</select>
								<label class="checkbox checkbox-inline" id="is_force" style="display: none;"><input id="force_pre_set" name="forcepreset" <?php if ( $flow['forcepreset'] == '1' ): ?>checked<?php endif; ?> type="checkbox" value="1" /><?php echo $lang['Force input']; ?></label>
							</div>
						</div>
					</div>
					<div>
