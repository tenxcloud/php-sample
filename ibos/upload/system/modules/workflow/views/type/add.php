				...
				<fieldset>
							...
							<select name="catid" id="flow_catid" class="span3">
								<?php if ( !empty( $this->category ) ): ?>
									<?php foreach ( $this->category as $category ): ?>
										<option<?php if ( $category['catid'] == $this->catid ): ?> selected<?php endif; ?> value="<?php echo $category['catid']; ?>"><?php echo $category['name']; ?></option>
									<?php endforeach; ?>
								<?php endif; ?>
							</select>
						</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<!--<label class="checkbox checkbox-inline"><input type="checkbox" name="allowversion" value="1" /><?php // echo $lang['Enable version control'];  ?></label>功能还未开发-->
						</div>
					</div>
					<div class="control-group">
