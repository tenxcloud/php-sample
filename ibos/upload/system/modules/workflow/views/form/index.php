...
<form method="post" enctype="multipart/form-data" action="<?php echo $this->createUrl( 'form/index' ); ?>" id="wf_handle_form">
    <div class="wrap host-wrap">
        <!--超时提醒-->
        <?php if ( $flow['type'] == '1' && $timeUsed > ($process['timeout'] * 3600) ): ?>
            <div class="alert alert-danger" id="delay_remind"><?php echo Ibos::lang( 'Your work has overtimed', '', array( '{time}' => Common::getTime( $timeUsed - $process['timeout'] * 3600 ) ) ); ?></div>
        <?php endif; ?>
        <!--表单区域begin-->
                                        ...
                                        <?php foreach ( $attachData as $attach ): ?>
                                            ...
                                            <tr id='attach_<?php echo $attach['aid']; ?>'>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="attachment-content"><?php echo $flow['type'] == '1' ? $prcscache[$attach['description']]['name'] : Ibos::lang( 'No.step','',array('{step}'=>$attach['description'])); ?></span>
                                                </td>
                                                <td>
                                                    <div class="pull-right">
                                                        <ul class="list-inline">
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if ( isset( $attach['officeediturl'] ) ): ?><li><a href="<?php echo $attach['officeediturl']; ?>" target="_blank" class="o-edit cbtn" title="编辑"></a></li><?php endif; ?>
                                                            <?php if ( $attach['down'] == 1 ): ?><li><a href="<?php echo $attach['downurl']; ?>" target='_blank' class="o-host-download" title="下载"></a></li><?php endif; ?>
                                                            <?php if ( $attach['delete'] == 1 ): ?><li><a href="javascript:void(0);" data-click='delAttach' data-param="{&quot;runid&quot;:&quot;<?php echo $run['runid']; ?>&quot;,&quot;aid&quot;:&quot;<?php echo $attach['aid']; ?>&quot;}" class="o-trash cbtn" title="删除"></a></li><?php endif; ?>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
                                                    ...
                                                    <?php foreach ( $fb['attachment'] as $attach ): ?>
                                                        <div>
                                                            ...
                                                            <div class="type-attachment" class="pull-right">
                                                                ...
                                                                <span>
                                                                    <?php if ( $attach['down'] ): ?><a class="attachment-upload" target="_blank" href="<?php echo $attach['downurl'] ?>"><?php echo $lang['Download']; ?></a>&nbsp;<?php endif; ?>
                                                                    <?php if ( isset( $attach['officereadurl'] ) ): ?>
                                                                        <a  href="javascript:;" class="attachment-upload" data-action="viewOfficeFile" data-param='{"href": "<?php echo $attach['officereadurl']; ?>"}'>
                                                                            <?php echo $lang['Read']; ?>
                                                                        </a>
                                                                    <?php endif; ?>
                                                                    <?php if ( isset( $attach['officeediturl'] ) && $attach['uid'] == $this->uid ): ?><a class="attachment-upload" target="_blank" href="<?php echo $attach['officeediturl'] ?>"><?php echo $lang['Edit']; ?></a><?php endif; ?>
                                                                    <?php if ( $attach['uid'] == $this->uid ): ?><a class="attachment-upload" data-click="delFbAttach" data-param="{&quot;feedid&quot;:&quot;<?php echo $fb['feedid']; ?>&quot;,&quot;aid&quot;:&quot;<?php echo $attach['aid']; ?>&quot;}" href="javascript:void(0);"><?php echo $lang['Delete']; ?></a><?php endif; ?>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    <?php endforeach; ?>
                                                ...
                                                <div class="clearfix">
                                                    ...
                                                    <div class="pull-right approve-handle" id="leader_reply">
                                                        <ul class="list-inline">
                                                            ...
                                                            <?php endif; ?>
                                                                <?php if ( $allowFeedback ): ?><li><a href="javascript:;" data-param='{&quot;feedid&quot;:&quot;<?php echo $fb['feedid']; ?>&quot;}' data-click="loadFbReply" class="reply-option"><?php echo $lang['Reply']; ?>(<?php echo $fb['count']; ?>)</a></li><?php endif; ?>
                                                            <?php if ( $fb['uid'] == $this->uid ): ?>&nbsp;|<li><a href="javascript:void(0);" data-click="delFb" data-param="{&quot;feedid&quot;:&quot;<?php echo $fb['feedid']; ?>&quot;}"><?php echo $lang['Delete']; ?></a></li><?php endif; ?>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </li>
                    ...
                    <?php if ( $allowFeedback ): ?>
                        <li class="clearfix">
                            <div class="opinion-type pull-left">
                                ...
                                <div class="type-content"><?php echo $lang['Cur step']; ?><?php if ( $flow['type'] == '1' && $process['feedback'] == '2' ): ?><span class="xcr"><?php echo $lang['Force sign']; ?></span><?php endif; ?></div>
                            </div>
                                    ...
                                    <div class="opinion-form-foot">
                                        <div class="pull-left">
                                            <?php if ( $allowAttach ): ?>
                                                ...
                                                <button type="button" class="btn btn-icon vat" data-action="selectFile" data-param='{"target": "#fb_file_target", "input": "#fbattachmentid"}'>
    ...
    <span class="support-tip">启用会签手写签章功能(试用版<span class="test-password">密码:111</span>,购买请联系我们.)</span>
                                        ...
                                        <!--<div class="pull-right">
                                            <button type="button" class="btn"><?php echo $lang['Handwritten']; ?></button>
                                            <button type="button" class="btn"><?php echo $lang['Signature']; ?></button>
                                        </div>-->
                                    </div>
                                </div>
                            </div>
        ...
        <div class="wf-quick-link">
            <ul>
                ...
                <?php if ( $allowAttach ): ?><li><a href="#attachment" class="o-sb-attachment" title="<?php echo $lang['Attachment']; ?>"></a></li><?php endif; ?>
                <?php if ( $allowFeedback ): ?><li><a href="#opinion" class="o-sb-sign" title="<?php echo $lang['Sign']; ?>"></a></li><?php endif; ?>
            ...
            <div id="fallback_box" style="display: none;">
                <div>
                    <?php foreach ( $backlist as $index => $backstep ): ?>
                        <label class="radio "><input type="radio" <?php if ( $index == 0 ): ?>checked<?php endif; ?> name="prcs" value="<?php echo $backstep['id']; ?>"/><?php echo $backstep['id'] . ':' . $backstep['name']; ?></label>
                    <?php endforeach; ?>
                </div>
...
<?php if ( !empty( $form['script'] ) ): ?>
    ...
    <?php echo $form['script']; ?>
            ...
            Ui.tip(Ibos.l('WF.CUSTOM_SCRIPT_ERROR') + err);
        }
<?php endif; ?>
    ...
    $(function() {
        ...
        // 新手引导
        setTimeout(function() {
            Ibos.guide("wf_form_index", function() {
                var guideData = [
                    {
                        element: "#steps_preview",
                        intro: WF.INTRO.STEPS_PREVIEW,
                        position: "left"
                    },
                    {
                        element: "#turn",
