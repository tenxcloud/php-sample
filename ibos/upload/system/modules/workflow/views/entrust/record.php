					...
					<table class="table table-hover table-striped table-record">
						<thead>
							<tr>
								...
								<th width="80"><?php echo $lang['Be entrust user']; ?></th>
								<th width="100"><?php echo $lang['Entrust time']; ?></th>
							</tr>
						</thead>
						<tbody>
							<?php foreach ( $list as $key => $val ): ?>
								<tr>
									...
									<td>
										...
										<span class="fss dib step-text-nowrap"><a data-param="{&quot;key&quot;: &quot;<?php echo $val['key']; ?>&quot;}" href="javascript:void(0);" data-click="viewFlow"><?php echo $val['processname']; ?></a></span>
									</td>
									<td>
										<?php if ( $val['flag'] == '3' ): ?>
									...
									<td>
										<span class="fss tcm"><?php echo Convert::formatDate( $val['time'] ); ?></span>
									</td>
								</tr>
							<?php endforeach; ?>
						</tbody>
					...
					<div class="btn-group dropup">
						...
						<ul class="dropdown-menu" id="page_num_menu">
							<li <?php if ( $pageSize == 10 ): ?>class="active"<?php endif; ?>>
								<a href="<?php echo $this->createUrl( 'entrust/index', array( 'op' => $op, 'pagesize' => 10 ) ); ?>"><?php echo $lang['Each page']; ?> 10</a>
							</li>
							<li <?php if ( $pageSize == 20 ): ?>class="active"<?php endif; ?>>
								<a href="<?php echo $this->createUrl( 'entrust/index', array( 'op' => $op, 'pagesize' => 20 ) ); ?>"><?php echo $lang['Each page']; ?> 20</a>
							</li>
							<li <?php if ( $pageSize == 30 ): ?>class="active"<?php endif; ?>>
								<a href="<?php echo $this->createUrl( 'entrust/index', array( 'op' => $op, 'pagesize' => 30 ) ); ?>"><?php echo $lang['Each page']; ?> 30</a>
							</li>
							<li <?php if ( $pageSize == 40 ): ?>class="active"<?php endif; ?>>
								<a href="<?php echo $this->createUrl( 'entrust/index', array( 'op' => $op, 'pagesize' => 40 ) ); ?>"><?php echo $lang['Each page']; ?> 40</a>
							</li>
							<li <?php if ( $pageSize == 50 ): ?>class="active"<?php endif; ?>>
								<a href="<?php echo $this->createUrl( 'entrust/index', array( 'op' => $op, 'pagesize' => 50 ) ); ?>"><?php echo $lang['Each page']; ?> 50</a>
							</li>
						</ul>
					</div>
				</div>
