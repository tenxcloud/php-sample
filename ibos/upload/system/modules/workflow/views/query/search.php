				...
				<div class="pull-left">
					<select class="form-control pull-left select-plan" id="select_prepare_project">
						...
						<?php foreach ( $tpls as $opt ) : ?>
							<option value="<?php echo $opt['seqid']; ?>" <?php if ( $id == $opt['seqid'] ): ?>selected<?php endif; ?>><?php echo $opt['tplname']; ?></option>
						<?php endforeach; ?>
					</select>
						...
						<div class="control-group"> 
							...
							<div class="controls">
								<select name="flow_query_type" class="form-control qf-short-select" id="query_range">
									<option value="all" <?php if ( $edit && $tpl['flow']['flowquerytype'] == 'all' ): ?>selected<?php else: ?>selected<?php endif; ?>><?php echo $lang['Query scope all']; ?></option>
									<option value="1" <?php if ( $edit && $tpl['flow']['flowquerytype'] == '1' ): ?>selected<?php endif; ?>><?php echo $lang['Query scope 1']; ?></option>
									<option value="2" <?php if ( $edit && $tpl['flow']['flowquerytype'] == '2' ): ?>selected<?php endif; ?>><?php echo $lang['Query scope 2']; ?></option>
									<option value="3" <?php if ( $edit && $tpl['flow']['flowquerytype'] == '3' ): ?>selected<?php endif; ?>><?php echo $lang['Query scope 3']; ?></option>
								</select>
							</div>
						</div>
						<div class="control-group"> 
						...
						<div class="control-group"> 
							...
							<div class="controls">
								<select name="flow_status" class="form-control qf-short-select" id="flow_state">
									<option value="all" <?php if ( $edit && $tpl['flow']['flowstatus'] == 'all' ): ?>selected<?php else: ?>selected<?php endif; ?>><?php echo $lang['All']; ?></option>
									<option value="1" <?php if ( $edit && $tpl['flow']['flowstatus'] == '1' ): ?>selected<?php endif; ?>><?php echo $lang['Being performed']; ?></option>
									<option value="0" <?php if ( $edit && $tpl['flow']['flowstatus'] == '0' ): ?>selected<?php endif; ?>><?php echo $lang['Has ended']; ?></option>
								</select>
							</div>
						</div>
								...
								<div class="controls">
									<select name="group_field" class="form-control qf-long-select" id="group_by_name">
										<?php foreach ( array_merge( $deftitle, $title ) as $index => $value ): ?>
											<option value="<?php echo $value['key']; ?>" <?php if ( $edit && ($value['key'] == $tpl['group']['field']) ): ?>selected<?php endif; ?>><?php echo $value['title']; ?></option>
										<?php endforeach; ?>
									</select>
									<select name="group_sort" class="form-control qf-short-select" id="sort_type">
										<option value="asc" <?php if ( $edit && $tpl['group']['order'] == 'asc' ): ?>selected<?php endif; ?>><?php echo $lang['Ascending']; ?></option>
										<option value="desc" <?php if ( $edit && $tpl['group']['order'] == 'desc' ): ?>selected<?php endif; ?>><?php echo $lang['Descending']; ?></option>
									</select>
								</div>
							</div>
							<div class="control-group">
