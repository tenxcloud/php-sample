				...
				<div class="control-group"> 
					...
					<div class="controls clearfix">
						...
						<div class="btn-group ml" id="flow_type">
							<a href="javascript:void(0);" data-type="type" data-param="all" class="btn<?php if ( $type == 'all' ): ?> active<?php endif; ?>"><?php echo $lang['All of it']; ?></a>
							<a href="javascript:void(0);" data-type="type" data-param="perform" class="btn<?php if ( $type == 'perform' ): ?> active<?php endif; ?>"><span class="xcgn"><?php echo $lang['Perform']; ?></span></a>
							<a href="javascript:void(0);" data-type="type" data-param="end" class="btn<?php if ( $type == 'end' ): ?> active<?php endif; ?>"><span class="tcm"><?php echo $lang['Has ended']; ?></span></a>
						</div>
					</div>
				</div>
				<div class="control-group"> 
					...
					<div class="controls clearfix">
						<ul class="range-select btn-range pull-left">
							<li <?php if ( $scope == 'none' ): ?>class="active"<?php endif; ?>>
								<a href="javascript:void(0);" data-type="scope" data-param="none"><?php echo $lang['No limit']; ?></a>
							</li>
							<li <?php if ( $scope == 'start' ): ?>class="active"<?php endif; ?>>
								<a href="javascript:void(0);" data-type="scope" data-param="start"><?php echo $lang['I started']; ?></a>
							</li>
							<li <?php if ( $scope == 'handle' ): ?>class="active"<?php endif; ?>>
								<a href="javascript:void(0);" data-type="scope" data-param="handle"><?php echo $lang['I handleing']; ?></a>
							</li>
							<li <?php if ( $scope == 'manage' ): ?>class="active"<?php endif; ?>>
								<a href="javascript:void(0);" data-type="scope" data-param="manage"><?php echo $lang['I manage']; ?></a>
							</li>
							<li <?php if ( $scope == 'focus' ): ?>class="active"<?php endif; ?>>
								<a href="javascript:void(0);" data-type="scope" data-param="focus"><?php echo $lang['I focus']; ?></a>
							</li>
						</ul>
						<div class="span5 pull-left choose-range">
							<input type="text" data-type="beginuser" <?php if ( isset($beginuser) ): ?>value="<?php echo $beginuser; ?>"<?php endif; ?> id="choose_range" placeholder="<?php echo $lang['Specify the originator']; ?>" />
						</div>
					</div>
				</div>
				<div class="control-group"> 
					...
					<div class="controls clearfix">
						<select class="form-control pull-left qf-short-select" data-type="time" id="time_user_defined">
							<option value="none" <?php if ( $time == 'none' ): ?>selected<?php endif; ?>><?php echo $lang['No limit']; ?></option>
							<option value="today" <?php if ( $time == 'today' ): ?>selected<?php endif; ?>><?php echo $lang['Today']; ?></option>
							<option value="yesterday" <?php if ( $time == 'yesterday' ): ?>selected<?php endif; ?>><?php echo $lang['Yesterday']; ?></option>
							<option value="thisweek" <?php if ( $time == 'thisweek' ): ?>selected<?php endif; ?>><?php echo $lang['This week']; ?></option>
							<option value="lastweek" <?php if ( $time == 'lastweek' ): ?>selected<?php endif; ?>><?php echo $lang['Last week']; ?></option>
							<option value="thismonth" <?php if ( $time == 'thismonth' ): ?>selected<?php endif; ?>><?php echo $lang['This month']; ?></option>
							<option value="lastmonth" <?php if ( $time == 'lastmonth' ): ?>selected<?php endif; ?>><?php echo $lang['Last month']; ?></option>
							<option value="custom" <?php if ( $time == 'custom' ): ?>selected<?php endif; ?>><?php echo $lang['Custom']; ?></option>
						</select>
						<div class="span4 pull-left wq-time-grorp<?php if ( $time == 'custom' ): ?> show<?php endif; ?>">
								...
								<tr id="list_tr_<?php echo $val['runid']; ?>">
									...
									<td>
										<?php if ( !empty( $val['attachmentid'] ) ): ?>
											<div class="fill-mm q-attachment-area" data-placement="bottom" data-html="true" data-original-title="<ul><?php foreach ( $val['attachdata'] as $attach ): ?><li><?php echo $attach['filename']; ?></li><?php endforeach; ?></ul>">
					...
					<div class="btn-group dropup">
						...
						<ul class="dropdown-menu" id="page_num_menu">
							<li <?php if ( $pageSize == 10 ): ?>class="active"<?php endif; ?>>
								<a href="<?php echo $this->createUrl( 'query/index', array( 'pagesize' => 10 ) ); ?>"><?php echo $lang['Each page']; ?> 10</a>
							</li>
							<li <?php if ( $pageSize == 20 ): ?>class="active"<?php endif; ?>>
								<a href="<?php echo $this->createUrl( 'query/index', array( 'pagesize' => 20 ) ); ?>"><?php echo $lang['Each page']; ?> 20</a>
							</li>
							<li <?php if ( $pageSize == 30 ): ?>class="active"<?php endif; ?>>
								<a href="<?php echo $this->createUrl( 'query/index', array( 'pagesize' => 30 ) ); ?>"><?php echo $lang['Each page']; ?> 30</a>
							</li>
							<li <?php if ( $pageSize == 40 ): ?>class="active"<?php endif; ?>>
								<a href="<?php echo $this->createUrl( 'query/index', array( 'pagesize' => 40 ) ); ?>"><?php echo $lang['Each page']; ?> 40</a>
							</li>
							<li <?php if ( $pageSize == 50 ): ?>class="active"<?php endif; ?>>
								<a href="<?php echo $this->createUrl( 'query/index', array( 'pagesize' => 50 ) ); ?>"><?php echo $lang['Each page']; ?> 50</a>
							</li>
						</ul>
					</div>
				</div>
