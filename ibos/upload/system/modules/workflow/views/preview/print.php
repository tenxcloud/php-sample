...
<div class="wrap">
											...
											<td>
												<div class="pull-right">
													<ul class="list-inline">
														<?php if ( $attach['down'] == 1 ): ?><li><a href="<?php echo $attach['downurl']; ?>" target='_blank' class="o-host-download" title="<?php echo $lang['Download']; ?>"></a></li><?php endif; ?>
														...
														<li class="cmt-item">
															...
															<div class="cmt-body fss">
																<p class="xcm">
																	...
																	<?php echo $rp['content']; ?>
																	<span class="tcm ilsep">(<?php echo Convert::formatDate( $rp['edittime'], 'u' ); ?>)</span>
																</p>
															</div>
														</li>
													<?php endforeach; ?>
	...
	<div class="wf-quick-link">
		<ul>
			<?php if ( $formview ): ?><li><a href="javascript:;" data-action="scrollToForm" class="o-sb-form" title="<?php echo $lang['Form']; ?>"></a></li><?php endif; ?>
			<?php if ( $attachview ): ?><li><a href="javascript:;" data-action="scrollToAttachment" class="o-sb-attachment" title="<?php echo $lang['Attachment']; ?>"></a></li><?php endif; ?>
			<?php if ( $signview ): ?><li><a href="javascript:;" data-action="scrollToOpinion" class="o-sb-sign" title="<?php echo $lang['Sign']; ?>"></a></li><?php endif; ?>
			<?php if ( $chartview ): ?><li><a href="javascript:;" data-action="scrollToChart" class="o-sb-chart" title="<?php echo $lang['Flow chart']; ?>"></a></li><?php endif; ?>
	...
	<script>
		$(function() {
			...
			// 新手引导
			setTimeout(function(){
				Ibos.guide("wf_pre_print", [
					{ 
						element: "#choose_display", 
						intro: U.lang("WF.INTRO.DISPLAY_PANEL")
					},
					{
						element: ".wf-quick-link",
						intro: U.lang("WF.INTRO.QUICK_LINK"),
						position: "left"
					}
				]);
			}, 1000)
