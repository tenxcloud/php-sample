								...
								<tr id="list_tr_<?php echo $run['runid']; ?>">
									...
									<td>
										<div class="com-list-name">
											<em class="text-nowrap"><a class="xcm" title="<?php echo $run['runName']; ?>" target="_blank" href="<?php echo $this->createUrl( 'preview/flow', array( 'key' => $run['key'] ) ); ?>"><?php echo String::cutStr( $run['runName'], 25 ); ?></a></em>
