		...
		<div class="fill">
			...
			<div id="primary_param">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" value="<?php echo $tpl['tplname']; ?>" name="tplname" id="tplname" class="span4">
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<select name="flow_query_type" class="span4">
							<option value="all" <?php if ( $tpl['flow']['flowquerytype'] == 'all' ): ?>selected<?php endif; ?>><?php echo $lang['Query scope all']; ?></option>
							<option value="1" <?php if ( $tpl['flow']['flowquerytype'] == '1' ): ?>selected<?php endif; ?>><?php echo $lang['Query scope 1']; ?></option>
							<option value="2" <?php if ( $tpl['flow']['flowquerytype'] == '2' ): ?>selected<?php endif; ?>><?php echo $lang['Query scope 2']; ?></option>
							<option value="3" <?php if ( $tpl['flow']['flowquerytype'] == '3' ): ?>selected<?php endif; ?>><?php echo $lang['Query scope 3']; ?></option>
						</select>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" value="<?php echo $tpl['flow']['beginuser']; ?>" name="begin_user" id="flow_initiator">
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?php echo $lang['Flow subject/num']; ?></label>
					<div class="controls">
						<input type="text" name="run_name" value="<?php echo $tpl['flow']['runname']; ?>" />
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<select name="flow_status" data-type="flow_status" class="span4">
							<option value="all" <?php if ( $tpl['flow']['flowstatus'] == 'all' ): ?>selected<?php endif; ?>><?php echo $lang['All']; ?></option>
							<option value="1" <?php if ( $tpl['flow']['flowstatus'] == '1' ): ?>selected<?php endif; ?>><?php echo $lang['Being performed']; ?></option>
							<option value="0" <?php if ( $tpl['flow']['flowstatus'] == '0' ): ?>selected<?php endif; ?>><?php echo $lang['Has ended']; ?></option>
						</select>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						...
						<div class="dib" style="width: 220px;">
							<div class="datepicker" id="flow_begin_startdate">
								...
								<input type="text" id="start_begin" name="time1" class="datepicker-input" value="<?php echo $tpl['flow']['time1']; ?>">
							</div>
						</div>
						<div class="dib" style="width: 220px;">
							<div class="datepicker" id="flow_begin_enddate">
								<a href="javascript:;" class="datepicker-btn"></a>
								<input type="text" id="start_end" name="time2" class="datepicker-input" value="<?php echo $tpl['flow']['time2']; ?>">
							</div>
						</div>
					</div>
				</div>
				<div class="control-group" id="flow_end_date_scope"<?php if ( $tpl['flow']['flowstatus'] !== '0' ): ?> style="display: none;"<?php endif; ?>>
					...
					<div class="controls">
						...
						<div class="dib" style="width: 220px;">
							<div class="datepicker" id="flow_finish_startdate">
								<a href="javascript:;" class="datepicker-btn"></a>
								<input type="text" id="end_begin" name="time3" class="datepicker-input" value="<?php echo $tpl['flow']['time3']; ?>">
							</div>
						</div>
						<div class="dib" style="width: 220px;">
							<div class="datepicker" id="flow_finish_enddate">
								<a href="javascript:;" class="datepicker-btn"></a>
								<input type="text" id="end_end" name="time4" class="datepicker-input" value="<?php echo $tpl['flow']['time4']; ?>">
							</div>
						</div>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="attach_name" value="<?php echo $tpl['flow']['attachname']; ?>" />
					</div>
				</div>
			</div>
			<!-- 表单数据条件 -->
			<div id="form_condition" style="display: none;">
				...
				<div>
					<select name="" id="condition_select" multiple>
						<?php if ( !empty( $conArr ) ): ?>
					...
					<input type="hidden" name="condformula" id="condition_result" value="<?php echo $tpl['condformula']; ?>">
				</div>
			</div>
			<!-- 统计报表选项 -->
			<div id="statistics_options" style="display: none;">
					...
					<div class="controls">
						<select name="group_field" class="span3">
							<?php foreach ( array_merge( $deftitle, $title ) as $index => $value ): ?>
								<option value="<?php echo $value['key']; ?>" <?php if ( $value['key'] == $tpl['group']['field'] ): ?>selected<?php endif; ?>><?php echo $value['title']; ?></option>
							<?php endforeach; ?>
						</select>
						<select name="group_sort" id="" class="span2">
							<option value="asc" <?php if ( $tpl['group']['order'] == 'asc' ): ?>selected<?php endif; ?>><?php echo $lang['Ascending']; ?></option>
							<option value="desc" <?php if ( $tpl['group']['order'] == 'desc' ): ?>selected<?php endif; ?>><?php echo $lang['Descending']; ?></option>
						</select>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls controls-content">
						<div class="crs-slt-left">
							...
							<div class="mbs">
								<select id="display_field" multiple>
									<?php $titleArr = array_merge( $deftitle, $title ); ?>
									<?php foreach ( $titleArr as $index => $value ): ?>
										<?php if ( in_array( $value['key'], $tpl['viewfields'] ) || empty( $tpl['viewfields'] ) ): ?>
											<option value="<?php echo $value['key']; ?>"><?php echo $value['title']; ?></option>
											<?php unset( $titleArr[$index] ); ?>
										<?php endif; ?>
									<?php endforeach; ?>
								</select>
							</div>
						...
						<div class="crs-slt-right">
							...
							<div class="mbs">
								<select id="hidden_field" multiple>
									<?php foreach ( $titleArr as $index => $value ): ?>
										<option value="<?php echo $value['key']; ?>"><?php echo $value['title']; ?></option>
									<?php endforeach; ?>
								</select>
				...
				<input type="hidden" name="sid" value="<?php echo $tpl['seqid']; ?>" />
