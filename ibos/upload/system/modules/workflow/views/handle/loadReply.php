            ...
            <li class="cmt-item">
                ...
                <div class="cmt-body fss">
                    <p class="xcm">
                        ...
                        <?php echo $fb['content']; ?>
                        <span class="tcm ilsep">(<?php echo Convert::formatDate( $fb['edittime'], 'u' ); ?>)</span>
                    </p>
                    <div class="xar">
                        <a href="javascript:;" data-click="setreply" data-param="{&quot;name&quot;:&quot;<?php echo $fb['user']['realname']; ?>&quot;}"><?php echo $lang['Reply']; ?></a>
                        <?php if ( $fb['uid'] == $this->uid ): ?><a href="javascript:;" class="mls" data-click="delreply" data-param="{&quot;feedid&quot;:&quot;<?php echo $fb['feedid']; ?>&quot;}"><?php echo $lang['Delete']; ?></a><?php endif; ?>
                    </div>
                </div>
            </li>
        <?php endforeach; ?>
