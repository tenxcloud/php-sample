...
<script type="text/template" id="loop_template">
	<tr id="loop_row_<%=calendarid%>">
		...
		<td>
			<a href="javascript:" data-action="editLoop" data-id="<%=calendarid%>" title="<?php echo $lang['Edit']; ?>" class="cbtn o-edit"></a>
			<a href="javascript:" data-action="deleteLoop" data-id="<%=calendarid%>"  title="<?php echo $lang['Delete']; ?>" class="cbtn o-trash"></a>
		</td>
	</tr>
</script>
