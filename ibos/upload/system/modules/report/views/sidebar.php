				...
				<?php foreach ( $reportTypes as $index => $reportType ): ?>
					...
					<?php else: ?>
						<tr data-id="<?php echo $reportType['typeid']; ?>">
							<td data-name="sort" data-value="<?php echo $reportType['sort']; ?>"><?php echo $reportType['sort']; ?></td>
							<td data-name="typename" data-value="<?php echo $reportType['typename']; ?>"><?php echo $reportType['typename']; ?></td>
							...
							<td>
								<a href="javascript:;" data-click="editType" class="anchor" data-id="<?php echo $reportType['typeid']; ?>"><?php echo $lang['Edit']; ?></a>
								<a href="javascript:;" data-click="removeType" class="anchor mlm" data-id="<?php echo $reportType['typeid']; ?>"><?php echo $lang['Delete']; ?></a>
							</td>
						</tr>
					<?php endif; ?>
				<?php endforeach; ?>
...
<script type="text/template" id="rp_type_tpl">
	<tr data-id="<%= typeid %>">
		...
		<td>
			<a href="javascript:;" data-click="editType" class="anchor" data-id="<%= typeid %>"><?php echo $lang['Edit']; ?></a>
			<a href="javascript:;" data-click="removeType" class="anchor mlm" data-id="<%= typeid %>"><?php echo $lang['Delete']; ?></a>
		</td>
	</tr>
</script>
	...
	<tr data-id="<%= typeid %>">
		...
		<td class="clearfix">
			<select name="intervaltype" class="input-small span5" style="float:left">
				<option value="0" <% if(intervaltype == 0) { %>selected<% } %>><?php echo $lang['Week']; ?></option>
				<option value="1" <% if(intervaltype == 1) { %>selected<% } %>><?php echo $lang['Month']; ?></option>
				<option value="2" <% if(intervaltype == 2) { %>selected<% } %>><?php echo $lang['Season']; ?></option>
				<option value="3" <% if(intervaltype == 3) { %>selected<% } %>><?php echo $lang['Half of a year']; ?></option>
				<option value="4" <% if(intervaltype == 4) { %>selected<% } %>><?php echo $lang['Year']; ?></option>
				<option value="5" <% if(intervaltype == 5) { %>selected<% } %>><?php echo $lang['Other']; ?></option>
			</select>
		...
		<td>
			<a href="javascript:;" data-click="saveType" class="anchor" data-id="<%= typeid %>"><%= Ibos.l("SAVE") %></a>
			<a href="javascript:;" data-click="cancelEdit" class="anchor mlm" data-id="<%= typeid %>"><%= Ibos.l("CANCEL") %></a>
		</td>
	</tr>
</script>
