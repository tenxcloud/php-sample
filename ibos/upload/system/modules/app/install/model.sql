...
DROP TABLE IF EXISTS `{{app_default}}`;
CREATE TABLE IF NOT EXISTS `{{app_default}}` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT COMMENT '流水ID',
  `widget` text NOT NULL COMMENT '板块应用，逗号隔开的应用ID',
  `shortcut` text NOT NULL COMMENT '其它应用，逗号隔开的应用ID',
  PRIMARY KEY (`id`)
...
INSERT INTO `{{nav}}`(`pid`, `name`, `url`, `targetnew`, `system`, `disabled`, `sort`, `module`) VALUES ('1','常用工具','app/default/index','0','1','0','3','app');
INSERT INTO `{{menu_common}}`( `module`, `name`, `url`, `description`, `sort`, `iscommon`) VALUES ('app','常用工具','app/default/index','提供企业App应用功能','11','0');
INSERT INTO `{{menu}}`(`name`, `pid`, `m`, `c`, `a`, `param`, `sort`, `disabled`) VALUES ('常用工具','0','app','dashboard','index','','14','0');
