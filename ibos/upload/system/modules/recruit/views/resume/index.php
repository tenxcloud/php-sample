                ...
                <ul class="mnv nl clearfix">
                    ...
                    <li <?php if ($type == 'arrange'): ?>class="active"<?php endif; ?>>
                        <a href="<?php echo $this->createUrl('resume/index', array('type' => 'arrange')); ?>">
                            ...
                            <?php if($countArramge != 0): ?><span class="bubble"><?php echo $countArramge; ?></span><?php endif; ?>
                        </a>
                    </li>
                    <li <?php if ($type == 'audition'): ?>class="active"<?php endif; ?>>
                        <a href="<?php echo $this->createUrl('resume/index', array('type' => 'audition')); ?>">
                            ...
                            <?php if($countAudition != 0): ?><span class="bubble"><?php echo $countAudition; ?></span><?php endif; ?>
                        </a>
                    </li>
                    ...
                    <li <?php if ($type == 'flag'): ?>class="active"<?php endif; ?>>
                        <a href="<?php echo $this->createUrl('resume/index', array('type' => 'flag')); ?>">
                           ...
                           <?php if($countAudition != 0): ?><span class="bubble"><?php echo $countFlag; ?></span><?php endif; ?>
                        </a>
                    </li>
            ...
            <div class="page-list">
                <div class="page-list-header">
                    <div class="btn-toolbar pull-left">
						...
						<a href="javascript:;" class="btn pull-left" id="del_rsm" data-action="deleteResumes"><?php echo $lang['Delete']; ?></a>
						<!-- 发送邮件-->
                        <a href="javascript:;" class="btn  pull-left" data-action="sendMail"><?php echo $lang['Send mail']; ?></a>	
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="javascript:;" data-action="moveToArranged"><?php echo $lang['To be arranged']; ?></a></li>
                                <li><a href="javascript:;" data-action="moveToInterview"><?php echo $lang['Audition']; ?></a></li>
                                <li><a href="javascript:;" data-action="moveToEmploy"><?php echo $lang['Hire']; ?></a></li>
                                <li><a href="javascript:;" data-action="moveToEliminate"><?php echo $lang['Eliminate']; ?></a></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <?php foreach ($resumeList as $resume) { ?>
                                <tr>
                                    ...
                                    <td>
										...
										<a href="javascript:" data-action="toggleResumeMark" data-id="<?php echo $resume['resumeid']; ?>" data-flag="0" title="<?php echo $lang['Unmark']; ?>"><i class="o-rsm-mark"></i></a>
                                        <?php else: ?>
                                            <a href="javascript:" data-action="toggleResumeMark" data-id="<?php echo $resume['resumeid']; ?>" data-flag="1" title="<?php echo $lang['Mark']; ?>"><i class="o-rsm-unmark"></i></a>
                                        <?php endif ?>
                                    </td>
                                </tr>
                            <?php } ?>
    ...
    <form id="recruit_import_form" enctype="multipart/form-data" action="<?php echo $this->createUrl('resume/add', array('op'=>'analysis')); ?>" method="post">
        <div class="form-horizontal form-compact">
            ...
            <div style="padding-left: 20px;">
				<textarea name="importContent" id="import_content" rows="4" cols="20" placeholder="<?php echo $lang['Please paste your resume content']; ?>" ></textarea>
			</div>
        </div>
    </form>
</div>
