...
INSERT INTO `{{nav}}` (`id`, `pid`, `name`, `url`, `targetnew`, `system`, `disabled`, `sort`, `module`, `type`, `pageid`) VALUES ('3', '0', '个人', 'javascript:void(0);', '0', '1', '0', '3','','0', '0');
INSERT INTO `{{nav}}` (`id`, `pid`, `name`, `url`, `targetnew`, `system`, `disabled`, `sort`, `module`, `type`, `pageid`) VALUES ('5', '0', '协作', 'javascript:void(0);', '0', '1', '0', '5','','0', '0');

INSERT INTO `{{nav}}` (`id`, `pid`, `name`, `url`, `targetnew`, `system`, `disabled`, `sort`, `module`, `type`, `pageid`) VALUES ('9', '0', '人力资源', 'javascript:void(0)', '0', '1', '0', '9','','0', '0');
