						...
						<div>
							<ul class="ztree org-utree org-corporation-utree">
								<li class="level0">
									...
									<a href="<?php echo $this->createUrl( 'user/index' ); ?>" target="_self" title="<?php echo $unit['fullname']; ?>" class="<?php if ( $deptId == 0 ): ?>curSelectedNode<?php endif; ?>">
										<span><?php echo $unit['fullname']; ?></span>
										<i class="o-org-ztree-edit pull-right opt-btn opt-edit-btn" title="编辑" data-url="<?php echo $this->createUrl( 'department/edit', array( 'deptid' => 0, 'op' => 'get' ) ); ?>" id="edit_corporation"></i>
									</a>
								</li>
							</ul>
						</div>
	...
	<div class="batch-result-wrap" id="batch_result_wrap" style="display:none;">
		...
		<div class="import-dialog-footer clearfix">
			<div class="pull-right">
				...
				<a href="javascript:;" class="btn" data-action="againImport">重新导入</a>
			</div>
		</div>
	</div>
</div>
