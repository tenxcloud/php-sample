			...
			<div class="aside" id="aside">
				<div class="main-nav">
					<ul id="main_nav">
						...
						<li>
							<a href="<?php echo $weixin['wxBinding']; ?>" target="main" data-href="#db_weixin_list" id="db_weixin" class="db-weixin"><?php echo $lang['Weixin']; ?></a>
						</li>
						<li>
				...
				<div class="sub-nav" id="sub_nav" style="overflow: auto">
					...
					<!-- 微信 -->
					<ul id="db_weixin_list" style="display:none;">
						<li class="active">
						...
						<li class="active">
							<a href="<?php echo $weixin['wxSync']; ?>" target="main" title="<?php echo $lang['Weixin sync']; ?>">
								<?php echo $lang['Weixin sync']; ?>
							</a>
						</li>
					</ul>
					<!-- 全局 -->
