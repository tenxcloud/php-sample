			...
			<div class="ctb">
				...
				<div class="sys-nav-area">
					<div class="sys-nav-top clearfix">
						...
						<div class="nav-w40">链接</div>
						<div class="nav-w6">是否启用</div>
						<div class="nav-w6">新窗口打开</div>
					</div>
													...
													<?php if ( $subVal['system'] == '1' ): ?>
								 					...
								 					<?php else: ?>
								 						<div class="nav-url <?php if($subVal['type'] == 1): ?>hidden<?php endif; ?>">
								 							<input type="text" data-type='url' class="input-small span11 <?php if($subVal['type'] == 0): ?>mark<?php endif; ?>" value="<?php if($subVal['type'] == 0): ?><?php echo $subVal['url']; ?><?php endif; ?>">	
								 						</div>
...
<script type="text/ibos-template" id="new_main_nav">
	<div class="nav-item main-nav-item">
		...
		<div class="nav-w40 system-url">
			<div class="nav-url">
				<input type="text" data-type='url' class="input-small span11 mark" name="newnavs[<%=id%>][url]">
