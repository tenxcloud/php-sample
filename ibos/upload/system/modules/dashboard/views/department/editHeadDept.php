...
<div class="ct">
	...
	<div>
		...
		<div class="ctb">
			...
			<div class="">
				<form action="<?php echo $this->createUrl( 'department/edit', array( 'deptid' => 0 ) ); ?>" method="post" class="department-info-form form-horizontal" id="edit_corption_form">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="phone" id="phone" value="<?php echo $unit['phone']; ?>" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label"><?php echo $lang['Fax']; ?></label>
						<div class="controls">
							<input type="text" name="fax" id="fax" value="<?php echo $unit['fax']; ?>" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label"><?php echo $lang['Zipcode']; ?></label>
						<div class="controls">
							<input type="text" name="zipcode" id="zipcode" value="<?php echo $unit['zipcode']; ?>" />
						</div>
					</div>
					<div class="control-group">
						<label for="" class="control-label"><?php echo $lang['Admin email']; ?></label>
						<div class="controls">
							<input type="text" name="adminemail" id="adminemail" value="<?php echo $unit['adminemail']; ?>" />
						</div>
					</div>
					<div class="control-group">
						<label for="" class="control-label"><?php echo $lang['Address']; ?></label>
						<div class="controls">
							<input type="text" name="address" id="address" value="<?php echo $unit['address']; ?>">
						</div>
					</div>
					<div class="control-group">
