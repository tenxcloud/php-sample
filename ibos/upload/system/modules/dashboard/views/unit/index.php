				...
				<form action="<?php echo $this->createUrl( 'unit/index' ); ?>" method="post" enctype="multipart/form-data" class="enterprise-info-form form-horizontal">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<?php else: ?>
								<input type="text" name="fullname" value="<?php echo $unit['fullname']; ?>" <?php if ( defined( 'LICENCE_VER' ) ): ?>readonly<?php endif; ?>>
							<?php endif; ?>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							...
							<?php else: ?>
								<input type="text" name="shortname" value="<?php echo $unit['shortname']; ?>" <?php if ( defined( 'LICENCE_VER' ) ): ?>readonly<?php endif; ?>>
							<?php endif; ?>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							...
							<?php else: ?>
								<input type="text" name="systemurl" value="<?php echo isset( $unit['systemurl'] ) ? $unit['systemurl'] : ""; ?>" <?php if ( defined( 'LICENCE_VER' ) ): ?>readonly<?php endif; ?>>
							<?php endif; ?>
						</div>
					</div>
					<div class="control-group">
