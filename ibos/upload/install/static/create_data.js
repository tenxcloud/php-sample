...
$(function(){
	//创建数据页面,点击显示更多后,隐藏部分信息显示
		...
		*/
		$("#protocol_choose").on("change",function(){	
			var value = $("#protocol_choose").prop("checked");
			if(value){
					$("#btn_install").addClass("btn-primary").prop("disabled", false); 
				}else{
					$("#btn_install").removeClass("btn-primary").prop("disabled", true); 
				}
			});
